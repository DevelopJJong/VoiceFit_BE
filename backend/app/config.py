...
SPOTIFY_CLIENT_ID = os.getenv("SPOTIFY_CLIENT_ID", "0ecb4c83d0914ca1a4b479b7ace0044c")
SPOTIFY_CLIENT_SECRET = os.getenv("SPOTIFY_CLIENT_SECRET", "86061dcb64fb432d84479b50993efcd4")
